...
al99 <- raster("inv_99.nc")     #importing images   # https://land.copernicus.vgt.vito.be/PDF/portal/Application.html#Browse;Root=511344;Time=NORMAL,NORMAL,-1,,,-1,,
al20 <- raster("inv_19.nc")     #importing images   # https://land.copernicus.vgt.vito.be/PDF/portal/Application.html#Browse;Root=511344;Time=NORMAL,NORMAL,-1,,,-1,,
...
ext <- c(-80,-10,60,90) 
al_inv99 <- crop(al_inv99, ext)      #crop function, cut the image thanks to the value of ext

# summer '99
al_est99 <- raster("est_99.nc")  #importing images
ext <- c(-80,-10,60,90) 
al_est99 <- crop(al_est99, ext)     #crop function, cut the image thanks to the value of ext
...
ext <- c(-80,-10,60,90)                        
al_est19 <- crop(al_est19, ext)        #crop function, cut the image thanks to the value of ext
...
plot(difinv, col=cldif, main="winter variation")       #plot function, col=link to colorRampPalette, main=title
plot(difest, col=cldif, main="summer variation")       #plot function, col=link to colorRampPalette, main=title
